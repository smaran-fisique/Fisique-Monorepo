...
export const FinalCTA = () => {
  const {
    data: ctaData
  } = useSection<FinalCTAData>('cta', defaultFinalCTAData);
  const {
    settings
  } = useSiteSettings();
  ...
  return <section className="py-[120px] text-center" style={{
    background: 'radial-gradient(60% 60% at 50% 0%, hsl(186 68% 45% / 0.18), transparent 60%)'
      ...
      <div className="container-custom max-w-[860px]">
        ...
        <div className="flex flex-wrap gap-4 justify-center pt-6">
          ...
          <a href={`https://wa.me/${whatsappNumber}?text=${consultMessage}`}>
              {ctaData.primaryCTA}
            </a>
          </Button>
