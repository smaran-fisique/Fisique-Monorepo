  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href={seo.canonicalUrl || "https://fisique.fitness/gym-tellapur"} />
        <meta property="og:title" content={seo.title} />
        <meta property="og:description" content={seo.description} />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://fisique.fitness/gym-tellapur" />
          ...
          <div className="container-custom relative">
            <div className="max-w-4xl">
              <div className="inline-flex items-center gap-2 bg-primary/10 border border-primary/20 rounded-full px-4 py-2 mb-6">
                ...
                <span className="text-sm font-medium text-primary">Just 12 mins from Tellapur</span>
              </div>

              <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold tracking-tight mb-6">
                Premium Gym Near{" "}
                <span className="text-primary">Tellapur</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-12">
                <Button size="lg" className="bg-accent hover:bg-accent/90 text-accent-foreground" asChild>
                  <a href="https://wa.me/919515469444?text=Hi%2C%20I%20live%20in%20Tellapur%20and%20I%27m%20interested%20in%20a%20free%20trial">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <div className="flex items-center gap-2 bg-card/50 border border-border/50 rounded-lg px-4 py-2">
                  ...
                  <span className="text-sm font-medium">Trusted by Tellapur Families</span>
                </div>
                <div className="flex items-center gap-2 bg-card/50 border border-border/50 rounded-lg px-4 py-2">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-6">
                  Why Tellapur Residents Choose Fisique
                </h2>
                <div className="prose prose-lg text-muted-foreground space-y-4">
                  <p>
                    Tellapur and Nallagandla are growing rapidly, but quality fitness options with expert coaching are still scarce. Most gyms in the area offer equipment access without the guidance you need.
                  </p>
                  <p>
                    Fisique Fitness is just 12 minutes via ORR, offering certified personal trainers who create customised programs, nutrition counseling, and an on-site sauna—a complete fitness ecosystem.
                  </p>
                  <p>
                    Our members from Tellapur treat the short drive as part of their fitness routine. They arrive, train with focus, recover in the sauna, and leave transformed.
                  </p>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-6 bg-card/50 border border-border/50 rounded-xl">
                  ...
                  <p className="text-sm text-muted-foreground">Certified trainers who customise every program.</p>
                </div>
                <div className="p-6 bg-card/50 border border-border/50 rounded-xl">
                  <Clock className="w-8 h-8 text-primary mb-4" />
                  <h3 className="font-semibold mb-2">Flexible Schedule</h3>
                  <p className="text-sm text-muted-foreground">Train early morning or late evening.</p>
                </div>
                <div className="p-6 bg-card/50 border border-border/50 rounded-xl">
                  <Thermometer className="w-8 h-8 text-primary mb-4" />
                  <h3 className="font-semibold mb-2">Sauna Recovery</h3>
                  <p className="text-sm text-muted-foreground">Relax and recover with on-site sauna.</p>
                </div>
                <div className="p-6 bg-card/50 border border-border/50 rounded-xl">
                  <Dumbbell className="w-8 h-8 text-primary mb-4" />
                  <h3 className="font-semibold mb-2">Boutique Space</h3>
                  <p className="text-sm text-muted-foreground">Uncrowded, premium, always available.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 sm:py-20 bg-primary/5 border-t border-border px-4">
          <div className="container-custom text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Join Tellapur residents who've made Fisique Fitness their gym of choice.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-accent hover:bg-accent/90 text-accent-foreground" asChild>
                <a href="https://wa.me/919515469444?text=Hi%2C%20I%20live%20in%20Tellapur%20and%20want%20to%20book%20a%20free%20trial">
                  <Phone className="w-5 h-5 mr-2" />
                  Book Free Trial
                </a>
              </Button>
