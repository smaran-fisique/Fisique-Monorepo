...
const GymManikonda = () => {
  const { seo } = useSEO('/gym-manikonda');
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href={seo.canonicalUrl || "https://fisique.fitness/gym-manikonda"} />
        <meta property="og:title" content={seo.title} />
        <meta property="og:description" content={seo.description} />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://fisique.fitness/gym-manikonda" />
          ...
          <div className="container-custom relative">
            <div className="max-w-4xl">
              <div className="inline-flex items-center gap-2 bg-primary/10 border border-primary/20 rounded-full px-4 py-2 mb-6">
                ...
                <span className="text-sm font-medium text-primary">Just 10 mins from Manikonda</span>
              </div>

              <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold tracking-tight mb-6">
                Premium Gym Near{" "}
                <span className="text-primary">Manikonda</span>
              </h1>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <div className="flex items-center gap-2 bg-card/50 border border-border/50 rounded-lg px-4 py-2">
                  ...
                  <span className="text-sm font-medium">Trusted by Manikonda Residents</span>
                </div>
                <div className="flex items-center gap-2 bg-card/50 border border-border/50 rounded-lg px-4 py-2">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-6">
                  Why Manikonda Residents Choose Fisique
                </h2>
                <div className="prose prose-lg text-muted-foreground space-y-4">
                  <p>
                    Manikonda has plenty of gyms, but finding one with personalised coaching and a premium experience is a different story. Most gyms in the area are packed and impersonal.
                  </p>
                  <p>
                    Fisique Fitness is just 10 minutes from Manikonda via ORR, offering what no gym nearby can: certified personal trainers, nutrition counseling included with every package, and a private sauna for recovery.
                  </p>
                  <p>
                    Our Manikonda members say the short drive is worth it for the personalised attention and the results they've achieved with us.
                  </p>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-6 bg-card/50 border border-border/50 rounded-xl">
                  ...
                  <p className="text-sm text-muted-foreground">Dedicated trainers who customise every session.</p>
                </div>
                <div className="p-6 bg-card/50 border border-border/50 rounded-xl">
                  <Clock className="w-8 h-8 text-primary mb-4" />
                  <h3 className="font-semibold mb-2">Early Bird Slots</h3>
                  <p className="text-sm text-muted-foreground">Open at 5:30 AM—workout before your commute.</p>
                </div>
                <div className="p-6 bg-card/50 border border-border/50 rounded-xl">
                  <Thermometer className="w-8 h-8 text-primary mb-4" />
                  <h3 className="font-semibold mb-2">Sauna Recovery</h3>
                  <p className="text-sm text-muted-foreground">On-site sauna for post-workout muscle recovery.</p>
                </div>
                <div className="p-6 bg-card/50 border border-border/50 rounded-xl">
                  <Dumbbell className="w-8 h-8 text-primary mb-4" />
                  <h3 className="font-semibold mb-2">Premium Equipment</h3>
                  <p className="text-sm text-muted-foreground">Top-tier equipment, always available.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 sm:py-20 bg-primary/5 border-t border-border px-4">
          <div className="container-custom text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Join Manikonda residents who've already discovered Fisique Fitness.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-accent hover:bg-accent/90 text-accent-foreground" asChild>
                <a href="https://wa.me/919515469444?text=Hi%2C%20I%20live%20in%20Manikonda%20and%20want%20to%20book%20a%20free%20trial">
                  <Phone className="w-5 h-5 mr-2" />
                  Book Free Trial
                </a>
              </Button>
