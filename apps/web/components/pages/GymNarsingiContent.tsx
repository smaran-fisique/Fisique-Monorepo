            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-6 bg-card/50 border border-border/50 rounded-xl">
                  ...
                  <p className="text-sm text-muted-foreground">1:1 training with coaches who track your progress and adjust your program.</p>
                </div>
                <div className="p-6 bg-card/50 border border-border/50 rounded-xl">
                  <Home className="w-8 h-8 text-primary mb-4" />
                  <h3 className="font-semibold mb-2">Family-Friendly</h3>
                  <p className="text-sm text-muted-foreground">Safe, welcoming environment for all fitness levels and age groups.</p>
                </div>
                <div className="p-6 bg-card/50 border border-border/50 rounded-xl">
                  <Thermometer className="w-8 h-8 text-primary mb-4" />
                  <h3 className="font-semibold mb-2">Sauna Recovery</h3>
                  <p className="text-sm text-muted-foreground">On-site sauna for muscle recovery and relaxation after your workout.</p>
                </div>
                <div className="p-6 bg-card/50 border border-border/50 rounded-xl">
                  <Dumbbell className="w-8 h-8 text-primary mb-4" />
                  <h3 className="font-semibold mb-2">Premium Equipment</h3>
                  <p className="text-sm text-muted-foreground">Top-tier equipment that's always available—no waiting, no crowds.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="container-custom">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <a href="/personal-training-kokapet" className="group p-8 bg-card border border-border/50 rounded-2xl hover:border-primary/50 hover:shadow-lg transition-all">
                ...
                <p className="text-muted-foreground mb-4">Transform your body with our 90-day programs. 1:1 coaching, nutrition guidance, and accountability to help you reach your goals.</p>
              ...
              <a href="/gym-membership-kokapet" className="group p-8 bg-card border border-border/50 rounded-2xl hover:border-primary/50 hover:shadow-lg transition-all">
                ...
                <p className="text-muted-foreground mb-4">Access premium equipment in a boutique setting. Perfect for self-motivated individuals who want a quality workout space.</p>
              ...
              <div className="p-8 bg-card border border-border/50 rounded-2xl">
                ...
                <p className="text-muted-foreground mb-4">Complete your fitness routine with sauna therapy. Great for muscle recovery, stress relief, and overall wellness.</p>
