    ...
    <>
      ...
      <main>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="mt-8 p-4 bg-primary/5 border border-primary/20 rounded-xl">
                  <h3 className="font-semibold mb-3 flex items-center gap-2">
                    <Building2 className="w-5 h-5 text-primary" />Quick Access from FD Offices
                  </h3>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-6 bg-card/50 border border-border/50 rounded-xl">
                  ...
                  <p className="text-sm text-muted-foreground">Professional gear for strength, cardio, and functional training.</p>
                </div>
                <div className="p-6 bg-card/50 border border-border/50 rounded-xl">
                  <Thermometer className="w-8 h-8 text-primary mb-4" />
                  <h3 className="font-semibold mb-2">Stress-Relief Sauna</h3>
                  <p className="text-sm text-muted-foreground">Perfect for high-stress IT clients needing recovery.</p>
                </div>
                <div className="p-6 bg-card/50 border border-border/50 rounded-xl">
                  <Users className="w-8 h-8 text-primary mb-4" />
                  <h3 className="font-semibold mb-2">Small Groups OK</h3>
                  <p className="text-sm text-muted-foreground">Can accommodate small corporate group sessions.</p>
                </div>
                <div className="p-6 bg-card/50 border border-border/50 rounded-xl">
                  <Clock className="w-8 h-8 text-primary mb-4" />
                  <h3 className="font-semibold mb-2">IT-Friendly Hours</h3>
                  <p className="text-sm text-muted-foreground">Open 5:30 AM - 10 PM to fit any work schedule.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 sm:py-20 bg-muted/30 border-t border-border px-4">
          <div className="container-custom">
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-center mb-4">Upgrade Your FD Clients' Experience</h2>
            <p className="text-muted-foreground text-center max-w-2xl mx-auto mb-12">What your IT professional clients get when you train them at Fisique</p>

            <div className="grid md:grid-cols-4 gap-6">
              {[
                { title: 'Air-Conditioned', desc: 'Comfortable year-round, no heat fatigue' },
                { title: 'Pro Equipment', desc: 'Better than apartment or office gyms' },
                { title: 'Sauna Recovery', desc: 'Stress relief for high-pressure jobs' },
                { title: 'Not Crowded', desc: 'Boutique environment, focused sessions' },
              ].map((item) => (
        ...
        <ReviewsSection />
        <FAQSection title="Freelance Training Near Financial District FAQs" subtitle="Questions about trainer access for FD professionals" faqs={freelanceFDFAQs} includeSchema={false} />
        ...
        <section className="py-16 sm:py-20 bg-primary/5 border-t border-border px-4">
          <div className="container-custom text-center">
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-4">Elevate Your Training Business</h2>
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">Trainers serving Financial District: upgrade your clients' experience with professional facilities. Contact us for trainer access rates.</p>
