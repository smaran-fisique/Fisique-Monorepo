            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-6 bg-card/50 border border-border/50 rounded-xl">
                  ...
                  <p className="text-sm text-muted-foreground">Top-tier strength training and cardio equipment</p>
                </div>
                <div className="p-6 bg-card/50 border border-border/50 rounded-xl">
                  <Users className="w-8 h-8 text-primary mb-4" />
                  <h3 className="font-semibold mb-2">1:1 Training</h3>
                  <p className="text-sm text-muted-foreground">Personal attention from certified coaches</p>
                </div>
                <div className="p-6 bg-card/50 border border-border/50 rounded-xl">
                  <Thermometer className="w-8 h-8 text-primary mb-4" />
                  <h3 className="font-semibold mb-2">Sauna Recovery</h3>
                  <p className="text-sm text-muted-foreground">On-site sauna for post-workout recovery</p>
                </div>
                <div className="p-6 bg-card/50 border border-border/50 rounded-xl">
                  <Clock className="w-8 h-8 text-primary mb-4" />
                  <h3 className="font-semibold mb-2">Flexible Hours</h3>
                  <p className="text-sm text-muted-foreground">Mon-Sat: 5:30 AM - 10 PM, Sun: 7 AM - 12 PM (Self-train)</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="container-custom">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              >
                ...
                <span className="text-primary font-medium">View plans →</span>
              </a>
              ...
              <div className="p-8 bg-card border border-border/50 rounded-2xl">
                ...
                <span className="text-muted-foreground">Included with PT</span>
              </div>
            </div>
          </div>
        </section>
