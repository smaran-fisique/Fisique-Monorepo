        ...
        <div className="container-custom max-w-4xl">
          ...
          <div className="prose prose-invert max-w-none space-y-6">
            ...
            <section>
              ...
              <p className="text-muted-foreground mb-3">We want you to be satisfied with your purchase. Exchanges are accepted under the following conditions:</p>
              <ul className="list-disc pl-6 text-muted-foreground space-y-2">
            ...
            <section>
              ...
              <p className="text-muted-foreground mb-3">If you receive a damaged or defective item:</p>
              <ul className="list-disc pl-6 text-muted-foreground space-y-2">
