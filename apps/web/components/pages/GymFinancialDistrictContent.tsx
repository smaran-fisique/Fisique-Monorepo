    ...
    <>
      ...
      <main>
          ...
          <div className="container-custom relative">
            <div className="max-w-4xl">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold tracking-tight mb-6">
                Premium Gym Near <span className="text-primary">Financial District</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-12">
                ...
                <Button size="lg" variant="outline" asChild>
                  <a href="https://maps.app.goo.gl/D1nMv22YD3yVSqUQ9" target="_blank" rel="noopener noreferrer">
                    <MapPin className="w-5 h-5 mr-2" />Get Directions from FD
                  </a>
                </Button>
              </div>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <div className="flex items-center gap-2 bg-card/50 border border-border/50 rounded-lg px-4 py-2"><Clock className="w-4 h-4 text-primary" /><span className="text-sm font-medium">Sun: 7 AM - 12 PM (Self-train)</span></div>
                <div className="flex items-center gap-2 bg-card/50 border border-border/50 rounded-lg px-4 py-2"><Building2 className="w-4 h-4 text-primary" /><span className="text-sm font-medium">Free Parking</span></div>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="mt-8 p-4 bg-primary/5 border border-primary/20 rounded-xl">
                  <h3 className="font-semibold mb-3 flex items-center gap-2"><Car className="w-5 h-5 text-primary" />Quick Commute from Financial District</h3>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-6 bg-card/50 border border-border/50 rounded-xl"><Users className="w-8 h-8 text-primary mb-4" /><h3 className="font-semibold mb-2">1:1 Personal Training</h3><p className="text-sm text-muted-foreground">No group classes, no distractions. Just you and your certified coach.</p></div>
                <div className="p-6 bg-card/50 border border-border/50 rounded-xl"><Clock className="w-8 h-8 text-primary mb-4" /><h3 className="font-semibold mb-2">IT-Friendly Hours</h3><p className="text-sm text-muted-foreground">Mon-Sat 5:30 AM - 10 PM. Sundays 7 AM - 12 PM (self-train only).</p></div>
                <div className="p-6 bg-card/50 border border-border/50 rounded-xl"><Thermometer className="w-8 h-8 text-primary mb-4" /><h3 className="font-semibold mb-2">Stress Relief Sauna</h3><p className="text-sm text-muted-foreground">Decompress after a stressful day with our on-site sauna facility.</p></div>
                <div className="p-6 bg-card/50 border border-border/50 rounded-xl"><Dumbbell className="w-8 h-8 text-primary mb-4" /><h3 className="font-semibold mb-2">No Waiting</h3><p className="text-sm text-muted-foreground">Limited membership means equipment is always available when you need it.</p></div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 sm:py-20 bg-muted/30 border-t border-border px-4">
          <div className="container-custom">
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-center mb-4">Services for Busy Professionals</h2>
            <p className="text-muted-foreground text-center max-w-2xl mx-auto mb-12">Efficient workouts designed to maximize results in minimal time</p>
            <div className="grid md:grid-cols-3 gap-8">
              <a href="/personal-training-kokapet" className="group p-8 bg-card border border-border/50 rounded-2xl hover:border-primary/50 hover:shadow-lg transition-all">
                ...
                <p className="text-muted-foreground mb-4">Our 90-day transformation programs are designed for professionals who need structured, efficient workouts that deliver visible results.</p>
              ...
              <a href="/gym-membership-kokapet" className="group p-8 bg-card border border-border/50 rounded-2xl hover:border-primary/50 hover:shadow-lg transition-all">
                ...
                <p className="text-muted-foreground mb-4">Premium equipment access in a boutique environment. No crowds, no waiting—just focused workouts when you need them.</p>
              ...
              <div className="p-8 bg-card border border-border/50 rounded-2xl">
                ...
                <p className="text-muted-foreground mb-4">Special rates for Financial District companies. Group wellness programs, team building sessions, and corporate discounts available.</p>
        ...
        <ReviewsSection />
        <FAQSection title="Questions from Financial District Professionals" subtitle="Common questions about our gym and services" faqs={financialDistrictFAQs} includeSchema={false} />

        <section className="py-16 sm:py-20 border-t border-border px-4">
          <div className="container-custom">
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-center mb-4">5 Minutes from Financial District</h2>
            <p className="text-muted-foreground text-center max-w-2xl mx-auto mb-12">Located in Kokapet, above Pulla Reddy Sweets in Avant Cedar—easy access from all FD offices</p>
            <div className="aspect-video rounded-2xl overflow-hidden border border-border">
              <iframe
                ...
                width="100%" height="100%" style={{ border: 0 }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Fisique Fitness - Near Financial District"
              />
            </div>
          </div>
        </section>
        ...
        <section className="py-16 sm:py-20 bg-primary/5 border-t border-border px-4">
          <div className="container-custom text-center">
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-4">Ready to Transform Your Fitness Routine?</h2>
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">Join other Financial District professionals who've made Fisique Fitness their go-to gym. Book a free trial and experience the difference.</p>
